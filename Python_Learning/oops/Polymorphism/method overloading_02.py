# in the previous programme (Method_overloading_01) we have seen method overloading achived my assigning default value to args in this programme we will perform method overloading using generic arguments i.e. none
