...
class jsongenerator:
    ...
    Snum=int(input("Enter the number of sensor for each equipment: "))
    print("Total {} equpments are available, for each equipment {} nos of sensor to be installed ".format(Enum,Snum))
    l=[]
